...
/*   Updated: 2025/03/27 11:08:14 by rwegat           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(std::string const &target)
{
	...
	std::cout << "ClapTrap Used 1 EP, Remaining EP: " << this->_energyPoints << std::endl;
}
...
void ClapTrap::takeDamage(int amount)
{
	...
	std::cout << "ClapTrap Remaining HP: " << this->_hitPoints << std::endl;
	if (this->_hitPoints == 0)
